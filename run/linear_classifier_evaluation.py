...
@hydra.main(config_path="../sce/configs/run/evaluation/linear_classifier/moco/resnet18", config_name="resnet18_cifar10")
def main(config: DictConfig) -> None:
    ...
    if config.get("test"):
        trainer.test(ckpt_path=config.test.ckpt_path, datamodule=datamodule)
